...
rm -f $JSON_PATH
gcloud storage \
	--impersonate-service-account="etl-crawlerteam-sa@opensanctions-ops.iam.gserviceaccount.com" \
	cp gs://resolver-backups.opensanctions.org/resolve.ijson $JSON_PATH
