...
from typing import Optional, List, Iterable, Dict, Any, IO, Tuple
...
person_schema = StructType(entity_fields + [
...
legal_entity_schema = StructType(entity_fields + [
    StructField("name", StringType(), True),
...
succession_schema = StructType(entity_fields + [
...
ownership_schema = StructType(entity_fields + [
...
directorship_schema = StructType(entity_fields + [
    # Only there for easy emission, always the parent
