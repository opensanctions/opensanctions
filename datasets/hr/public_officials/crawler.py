...
def handle_affiliation_data(context:Context, person:Entity, data:dict) -> None:
    """Creates, emits Position, Occupancy, and optionally a LegalEntity.
    Note that the provided data is incomplete and the modeling reflects this:  
      ...
      * A legal entity name with no position name results in an position with organizational reference
         named "Unspecified position"
