...
def assert_dom_hash(doc):
    ...
    # If the hash changes, update the xpath above and review the page structure
    # for any new tables that may have been added.
...
def crawl(context: Context):
    xpath = "//h5[contains(., 'Business enterprises involved in listed activities')]/following-sibling::div//table"
