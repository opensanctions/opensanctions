...
COUNTRIES = {
    ...
    "დიდი",  # Big
    "ლის ალბერტოდამოტაპიტო #",
    "იემენი",
    "ლიბერია",
    "ბუღდაისოქაქ",
    "ნეპალი",
    "ალიასღარ ხანჯანიჯელოუდარ",
    "სეინტ კიტს და ნევისი",
    "როშანაკ რეზაიმეჰრ",
    "პოლონეთი",
    "ალი აბბას აბდ ალი შამხი",
    "ყირგიზეთი",
    "ლიტვა",
    "საუდის არაბეთის სამეფო",
    'აფხაზინტერკონტი"',
    "ემად ედვარ ჰაბიბ აბდელმესსიჰ",
    "სეიედმოჰამადრეზა ჰოსეინიბასთანი",
    "დელავერის შტატი",
    "განა",
    "მოჰამადბაღერ ნიკბახშთეჰრანი",
    "დე კასტროს ქ #",
    "ვირჯინიისკუნძულები (ბრიტ )",
    "საუდისარაბეთის სამეფო",
    "გამბია",
    "ირლანდია",
    "დიდი ბრიტანეთი (GBR)",
    "უზბეკეთი",
    "არაბთა გაერთიანებული საამიროებ",
    "ჯავად ალი ა",
    "მეისამ ჰეიდარი სოურეშჯანი",
    "კენია",
    #############################################
    "დე კასტროს ქუჩა",
    "ემად ფარაგ იოაკიმ ბოტროს",
    "სადეღ თორქი ზადეჰ",
    "გამგეობის თავმჯდომარის მოადგილე",
    "არაბთა გაერთიანებულისაემიროები",
    'ახალი სტილი"',
    "აზარ მაჰმუდიალენჯარყი",
    "მოლდოვა",
    "შუმავსკას ქ",
    "ვირჯინიის",
    "თამარ ჯამარჯაშვილი",
    ...
    "ინკ",
    "ავთანდილ ნემსიწვერიძე",
    "შვეიცარია ()",
    "ლატვია",
    "სირია",
    "ალაა ეღბალბეჰბაჰანი",
    "ენდოკრინული და გულფილტვის დაავადებების ცენტრიდიაკორი",
    "#",
    "ბაჰრეინი",
    "ლიბანი",
    "მ",
    ...
    "ტაჯიკეთი",
    "თურქმენეთი",
    "რიმ ისსამ აბდელაზიმ აჰმედ ელატტარ",
    "გაბონი",
    "მარიამ ესმაილზადეჰ",
    'შავი ზღვის საერთაშორისოუნივერსიტეტი"',
    "ამორე",
    "ქ შკლოვი",
    "ზურაბ პოლოლიკაშვილი",
    "ირანი (ისლამური",
    ...
    "ვაი ჩუნგ ჩან",
    "იორდანია",
    "აჯელტაკისკუნძ სატრასტო კ",
    "სენტკიტსი დანევისი",
    "მობილია მალაზემელერი",
    "ჩილე",
    "დევიდ იჩბია",
    "რუსეთი",
    "ალი იბრაჰიმ ემ",
